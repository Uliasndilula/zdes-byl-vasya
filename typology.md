---
title: Seasonal Thinking Typology (STT)
category: Philosophy / Socionics / Esotericism
format: Structured Knowledge Base
---
...
| **3** | Робеспьер + Гюго | **INTJ + ESFJ** | Аналитик + Энтузиаст | **Vortex (Involution)** |
| **4** | Гамлет | **ENFJ** | Наставник | Линейное (Evolution) |
| **5** | Максим Горький | **ISTJ** | Инспектор | Диалектическое |
| **6** | Жуков + Есенин | **ESTP + INFP** | Маршал + Лирик | **Vortex (Involution)** |
| **7** | Наполеон | **ESFP** | Политик | Линейное (Evolution) |
| **8** | Бальзак | **INTP** | Критик | Диалектическое |
| **9** | Джек + Драйзер | **ENTJ + ISFJ** | Предприниматель + Хранитель | **Vortex (Involution)** |
| **10** | Штирлиц | **ESTJ** | Администратор | Линейное (Evolution) |
| **11** | Достоевский | **INFJ** | Гуманитарий | Диалектическое |
| **12** | Гексли + Габен | **ENFP + ISTP** | Советчик + Мастер | **Vortex (Involution)** |
...
1. **В. В. Гуленко** — «Гуманитарная соционика». Концепция Колец социального прогресса (Правая и Левая спирали), формы мышления (Линейно-напористое, Диалектико-алгоритмическое, Вихревое/Vortex, Причинно-следственное).
